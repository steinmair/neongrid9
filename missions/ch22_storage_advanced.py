"""
NeonGrid-9 :: Kapitel 22 — FINAL EXAM PROTOCOL
...
"Das ist kein Training mehr, Ghost.
 ...
 Du hast 21 Kapitel trainiert. Alle Fertigkeiten gelernt.
...
CHAPTER_22_MISSIONS: list[Mission] = [
    ...
    # ══════════════════════════════════════════════════════════════════════
    # 22.01 — Exam Block 1: Hardware, Boot, Kernel (101.x)
    # ══════════════════════════════════════════════════════════════════════
    Mission(
        mission_id   = "22.01",
        chapter      = 22,
  ...
  [ CHAPTER 22 :: FINAL EXAM - ALL DOMAINS ]
  > FINAL EXAM: All Linux Topics 101-110. Complete mastery test.""",
        story_transitions = [
            "21 Kapitel. Alle Topics. Alle Domains. Das ist die Final Exam.",
    ...
    # ══════════════════════════════════════════════════════════════════════
    # 22.02 — Exam Block 2: Dateisystem & Berechtigungen (102.x / 104.x)
    # ══════════════════════════════════════════════════════════════════════
    Mission(
        mission_id   = "22.02",
        chapter      = 22,
    ...
    # ══════════════════════════════════════════════════════════════════════
    # 22.03 — Exam Block 3: Shell, Prozesse & Netzwerk (103.x / 109.x)
    # ══════════════════════════════════════════════════════════════════════
    Mission(
        mission_id   = "22.03",
        chapter      = 22,
    ...
    # ══════════════════════════════════════════════════════════════════════
    # 22.04 — Exam Block 4: User, Logs, Cron, Scripting (105.x/107.x/108.x)
    # ══════════════════════════════════════════════════════════════════════
    Mission(
        mission_id   = "22.04",
        chapter      = 22,
    ...
    # ══════════════════════════════════════════════════════════════════════
    # 22.05 — Exam Block 5: Sicherheit, Locale, Shell-Env (105.1/107.3/110.x)
    # ══════════════════════════════════════════════════════════════════════
    Mission(
        mission_id   = "22.05",
        chapter      = 22,
    ...
    # ══════════════════════════════════════════════════════════════════════
    # 22.06 — Topic 101: System Architecture Deep Quiz
    # ══════════════════════════════════════════════════════════════════════
    Mission(
        mission_id   = "22.06",
        chapter      = 22,
    ...
    # ══════════════════════════════════════════════════════════════════════
    # 22.07 — Topic 102: Installation & Package Management Quiz
    # ══════════════════════════════════════════════════════════════════════
    Mission(
        mission_id   = "22.07",
        chapter      = 22,
    ...
    # ══════════════════════════════════════════════════════════════════════
    # 22.08 — Topic 103: GNU/Unix Command Quiz
    # ══════════════════════════════════════════════════════════════════════
    Mission(
        mission_id   = "22.08",
        chapter      = 22,
    ...
    # ══════════════════════════════════════════════════════════════════════
    # 22.09 — Topic 104: Filesystem Quiz
    # ══════════════════════════════════════════════════════════════════════
    Mission(
        mission_id   = "22.09",
        chapter      = 22,
    ...
    # ══════════════════════════════════════════════════════════════════════
    # 22.10 — Topic 105: Shell & Scripting Quiz
    # ══════════════════════════════════════════════════════════════════════
    Mission(
        mission_id   = "22.10",
        chapter      = 22,
    ...
    # ══════════════════════════════════════════════════════════════════════
    # 22.11 — Topic 107: Admin Tasks Quiz
    # ══════════════════════════════════════════════════════════════════════
    Mission(
        mission_id   = "22.11",
        chapter      = 22,
    ...
    # ══════════════════════════════════════════════════════════════════════
    # 22.12 — Topic 108: System Services Quiz
    # ══════════════════════════════════════════════════════════════════════
    Mission(
        mission_id   = "22.12",
        chapter      = 22,
    ...
    # ══════════════════════════════════════════════════════════════════════
    # 22.13 — Topic 109: Networking Deep Quiz
    # ══════════════════════════════════════════════════════════════════════
    Mission(
        mission_id   = "22.13",
        chapter      = 22,
    ...
    # ══════════════════════════════════════════════════════════════════════
    # 22.14 — Topic 110: Security Deep Quiz
    # ══════════════════════════════════════════════════════════════════════
    Mission(
        mission_id   = "22.14",
        chapter      = 22,
    ...
    # ══════════════════════════════════════════════════════════════════════
    # 22.15 — Exam Block 15: Topic 101.1 Hardware & Devices Deep
    # ══════════════════════════════════════════════════════════════════════
    Mission(
        mission_id   = "22.15",
        chapter      = 22,
    ...
    # ══════════════════════════════════════════════════════════════════════
    # 22.16 — Exam Block 16: Scripting & Automation Deep
    # ══════════════════════════════════════════════════════════════════════
    Mission(
        mission_id   = "22.16",
        chapter      = 22,
    ...
    # ══════════════════════════════════════════════════════════════════════
    # 22.17 — Exam Block 17: Netzwerk Advanced
    # ══════════════════════════════════════════════════════════════════════
    Mission(
        mission_id   = "22.17",
        chapter      = 22,
    ...
    # ══════════════════════════════════════════════════════════════════════
    # 22.18 — Exam Block 18: Gemischte Fragen (Timed Challenge)
    # ══════════════════════════════════════════════════════════════════════
    Mission(
        mission_id   = "22.18",
        chapter      = 22,
    ...
    # ══════════════════════════════════════════════════════════════════════
    # 22.19 — Exam Block 19: Storage & RAID Advanced
    # ══════════════════════════════════════════════════════════════════════
    Mission(
        mission_id   = "22.19",
        chapter      = 22,
    ...
    # ══════════════════════════════════════════════════════════════════════
    # 22.20 — Exam Block 20: Container & Virtualization
    # ══════════════════════════════════════════════════════════════════════
    Mission(
        mission_id   = "22.20",
        chapter      = 22,
    ...
    # ══════════════════════════════════════════════════════════════════════
    # 22.21 — Exam Block 21: Firewall & Security Advanced
    # ══════════════════════════════════════════════════════════════════════
    Mission(
        mission_id   = "22.21",
        chapter      = 22,
    ...
    # ══════════════════════════════════════════════════════════════════════
    # 22.22 — Exam Block 22: Network Services
    # ══════════════════════════════════════════════════════════════════════
    Mission(
        mission_id   = "22.22",
        chapter      = 22,
    ...
    # ══════════════════════════════════════════════════════════════════════
    # 22.23 — Exam Block 23: User Management Advanced
    # ══════════════════════════════════════════════════════════════════════
    Mission(
        mission_id   = "22.23",
        chapter      = 22,
    ...
    # ══════════════════════════════════════════════════════════════════════
    # 22.24 — Exam Block 24: Logging & Scheduling Deep
    # ══════════════════════════════════════════════════════════════════════
    Mission(
        mission_id   = "22.24",
        chapter      = 22,
    ...
    # ══════════════════════════════════════════════════════════════════════
    # 22.25 — Exam Block 25: Kernel & Hardware Deep
    # ══════════════════════════════════════════════════════════════════════
    Mission(
        mission_id   = "22.25",
        chapter      = 22,
    ...
    # ══════════════════════════════════════════════════════════════════════
    # 22.26 — Exam Block 26: Shell Scripting Advanced
    # ══════════════════════════════════════════════════════════════════════
    Mission(
        mission_id   = "22.26",
        chapter      = 22,
