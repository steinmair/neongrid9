...
CHAPTER_22_MISSIONS: list[Mission] = [
  ...
  ⚡ CHAOSWERK FACTION :: CHAPTER 22 BOSS ⚡""",
        ...
        quiz_questions = [
            QuizQuestion(
                question = "Welche fünf Befehle bilden den vollständigen Storage-Audit?",
                options  = [
                    "cat /proc/mdstat, vgs, lvs, repquota, df -h",
                    "ps aux, top, free, df, du",
                    "ping, dig, ss, ip, route",
                    "journalctl, dmesg, syslog, audit, security",
                ],
                correct  = 0,
                explanation = "RAID(mdstat), VG(vgs), LV(lvs), Quotas(repquota), Disk(df) = vollständiger Storage-Überblick.",
                xp_value = 30,
            ),
        ],
